...
以下为 Xiaomi Pad 6 Pro（liuqin）的当前移植状态，不是新安装包的真机验收结果。
...
| 触控 | Novatek NT36532 / SPI | ✅ 可用 | 点击、滑动与触控手势 |
...
| 加速度计 / 自动旋转 | SLPI / SSC / iio-sensor-proxy | 🟡 部分支持 | 当前安装版本的首次登录、连接磁吸键盘场景存在不旋转问题，尚未完成修复验收 |
